...
async def barcode_recommend(request: RecommendationRequest, token_valid: str = Depends(verify_token)):
    ...
    websocket_url = f"wss://ai-foodhak.com/ws/recommend/{user_id}"
    return {
...
async def startup_event():
    ...
    app.state.claude_client = AsyncAnthropic(api_key=os.getenv("ANTHROPIC_PRODUCTION_API_KEY"))
